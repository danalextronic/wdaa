...
jQuery.fn.sheepIt = function (options){
        ...
        function removeForm(formToRemove)
        {
            ...
            // add beforeRemoveCallback
            if(typeof options.beforeRemoveCurrent === 'function') {
                options.beforeRemoveCurrent(formToRemove, index);
            }
            ...
            if(typeof options.afterRemoveCurrent === 'function') {
                options.afterRemoveCurrent(formToRemove, index);
            }
        ...
        function fillForm(form, data)
        {
            ...
            $.each(data, function(index, value){
                ...
                // search for textarea by ID, name, etc.
                if(field.length == 0) {
                ...
                // search for select box by ID, name, etc.
                if(field.length == 0) {
        ...
        var  add
            ...
            ,defaults = {
                ...
                ,afterFill: function() {}
                ,beforeRemoveCurrent: function() {} // Callback function que se ejecuta justo despues de haber agregado un formulario
                ,afterRemoveCurrent: function() {} // Callback function que se ejecuta justo despues de haber agregado un formulario
